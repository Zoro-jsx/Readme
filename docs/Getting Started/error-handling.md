...
The Court Record Platform API returns standard HTTP status codes to indicate the success or failure of an API request. In addition, error responses contain a structured JSON body to help developers debug issues.
